...
const ActiveBuyList = () => {
  ...
  return (
    <div className="bg-gray-800 p-4 sm:p-6 rounded-lg shadow-xl mt-6">
      <h3 className="text-lg sm:text-xl font-semibold mb-4 text-green-400">Active Buy Trades</h3>
          ...
          <table className="w-full text-center text-sm sm:text-base">
            ...
            <tbody>
              {activeBuy.map((trade, index) => (
                <tr key={index} className="text-white border-b border-gray-700 text-center">
